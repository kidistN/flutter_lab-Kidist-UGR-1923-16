              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    TextButton.icon(
                      onPressed: () {
                        context.read<JournalProvider>().toggleFavorite(widget.quote.id);
                        setState(() {});
                      },
                      icon: Icon(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        await context.read<JournalProvider>().updatePersonalNote(
                          widget.quote.id,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              await context.read<JournalProvider>().deleteQuote(widget.quote.id);
              if (context.mounted) {
