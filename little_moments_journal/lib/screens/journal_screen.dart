  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          Consumer<JournalProvider>(
            builder: (context, provider, child) {
              return TextButton.icon(
                ...
                label: Text('${provider.savedQuotes.length} saved'),
      ...
      body: Consumer<JournalProvider>(
        builder: (context, provider, child) {
          if (provider.savedQuotes.isEmpty) {
            return Center(
              child: Column(
          ...
          return ListView.builder(
            ...
            itemCount: provider.savedQuotes.length,
            itemBuilder: (context, index) {
              final quote = provider.savedQuotes[index];
                ...
                onDismissed: (_) async {
                  ...
                  if (context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Quote removed from journal')),
                    );
                  }
                },
                child: Card(
